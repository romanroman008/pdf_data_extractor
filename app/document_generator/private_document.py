...
class PrivateDocument(IDocument):

    def add_personal_info(self):
        self._add_empty_lines(1)
        self.add_paragraph_with_bold_list(
            "Ja niżej podpisany(a) {0} legitymujący(a) się nr PESEL {1} zamieszkały(a) w {2}",
    ...
    def add_agreement_details(self):
        ...
        self._add_bold_and_italic_run(para, self.ownership.get_reg_unit())
